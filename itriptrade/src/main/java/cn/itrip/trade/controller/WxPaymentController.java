...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            ...
            String randomStr =""+random.nextDouble()*10000;
            String orderRamdom=   order+ randomStr.substring(0,3);
            ...
            //异步通知的URL地址。
            data.put("notify_url", "http://ftfcnm.free.idcfengye.com/itriptrade/api/wx/notify");
